...
<div class="embed-responsive clearfix embed-responsive-16by9 col-xs-12 text-center"  data-bind="visible: selectedDocument().embeddedVideoVisible, html: selectedDocument().embeddedVideo"></div>
<div class="embed-responsive clearfix embed-responsive-16by9 col-xs-12 text-center"  data-bind="visible: selectedDocument().embeddedAudioVisible, html: selectedDocument().embeddedAudio"></div>
</script>
